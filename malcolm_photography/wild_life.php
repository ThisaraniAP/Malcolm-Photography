...
<head>
    ...
    <style type="text/css">
        ...
        *{
        ...
        body {
            background-image: url('admin/images/wildlifebg.jpg');
        }
        h1{
...
<body>
    ...
    <center><h1>WILD LIFE GALLERY</h1></center>
    <div class="container col-lg-10">
        <div class="row">
            <?php 
                $sql = "SELECT * FROM tbl_photographs WHERE Cat='Wild Life';";
